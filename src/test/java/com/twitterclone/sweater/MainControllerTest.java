...
//pass a user under which we want to run those tests
@WithUserDetails("user")
//point to test properties with test Db
@TestPropertySource("/application-test.properties")
//sql files to go with tests where Db is used
...
public class MainControllerTest {
	...
	public void mainPageTest() throws Exception {
		...
		//insert xpath that appears after the user logs in
		// check that under that path we expect to see the logged user's name
		.andExpect(xpath("//div[@id=\"navbarSupportedContent\"]/div").string("user"));
		//If test fails need to make sure xml well-formed style is followed
	}
